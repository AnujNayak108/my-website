...
const About = () => {
    ...
    return (
        <div data-aos = "fade-up" id = "About" className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center w-full">
