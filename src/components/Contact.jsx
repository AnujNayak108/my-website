...
const Contact = () => {
  ...
  <h1 data-aos = "fade-down" className="text-[60px] font-semibold mb-20 leading-normal uppercase text-fuchsia-500 flex justify-center">Contact Me</h1>
      ...
      <form data-aos = "fade-right" action="#" class="space-y-8">
          <div>
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-white bg-fuchsia-600 rounded-2xl sub-button">Send message</button>
      </form>
  </div>
</section>
    )
